    ...
    return (
        <header className="sticky top-0 z-50 grid grid-cols-3 bg-[#0f0f0f] text-white shadow-md py-5 px-5 md:px-10" >
            ...
            <div className="flex items-center md:border-2 border-red-400 rounded-full py-2 md:shadow-sm" >
                <input className="flex-grow pl-5 bg-transparent outline-none text-sm text-white placeholder-grey-400" type="text" placeholder='Start Yout Search' value={searchInput} onChange={(e) => setSearchInput(e.target.value)} />
